...
const byte keyMap1[rowNum][colNum] = {
  { 0x00,           0x00, 0x27, 0x5B, 0x2D, 0x60                         ,0x5C, 0x3D, 0x5D, 0x27, 0x00, 0x00},
  ...
  { KEY_LEFT_SHIFT, 0x7A, 0x78, 0x63, 0x76, 0x62                         ,0x6E, 0x6D, 0x2C, 0x2E, 0x2F, KEY_RIGHT_SHIFT},
  { KEY_LEFT_CTRL, KEY_LEFT_CTRL, KEY_LEFT_GUI, KEY_LEFT_ALT, 0x00, 0x20 ,0x20, 0x00, KEY_LEFT_ARROW, KEY_UP_ARROW, KEY_DOWN_ARROW, KEY_RIGHT_ARROW}
};
const byte keyMap2[rowNum][colNum] = {
  { 0x00,           0x00, 0x22, 0x7B, 0x5F, 0x7E                                               ,0x7C, 0x2B, 0x7D, 0x22, 0x00, 0x00},
  ...
  { KEY_LEFT_SHIFT, 0x7A, 0x78, 0x63, 0x76, 0x62                                               ,0x6E, 0x6D, 0x2C, 0x2E, 0x2F, KEY_RIGHT_SHIFT},
  { KEY_LEFT_CTRL, KEY_LEFT_CTRL, KEY_LEFT_GUI, KEY_LEFT_ALT, 0x00, 0x20                       ,0x20, 0x00, KEY_HOME, KEY_PAGE_UP, KEY_PAGE_DOWN, KEY_END}
};
